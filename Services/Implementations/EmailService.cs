...
namespace New_folder.Services.Implementations
{
    public class EmailService : IEmailService
    {
        ...
        public void SendEMailAsync(EmailRequestModel mailRequest)
        {
            ...
            string SenderName = "Harvard Investment Global Service";
            string SenderEmail = "zafrullahdaprince@gmail.com";
            ...
            string ReplyToName = "Dansnom Farm";
            string ReplyToEmail = "zafrullahdaprince@gmail.com";
            SendSmtpEmailReplyTo ReplyTo = new SendSmtpEmailReplyTo(ReplyToEmail, ReplyToName);
            string stringInBase64 = "aGVsbG8gdGhpcyBpcyB0ZXN0";
            string AttachmentUrl = null;
            string AttachmentName = mailRequest.AttachmentName ?? "Welcome.txt";
            byte[] Content = Convert.FromBase64String(stringInBase64);
